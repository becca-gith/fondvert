<?php
/**
 * Template part : Nos partenaires (carrousel)
...
<style>
	/* =============================================
	   SECTION PARTENAIRES – Togo Green Fund TOGO
	   ============================================= */
	.client-carousel {
		--pc-green:       #0a6e3e;
	...
	/* Liseré drapeau du Togo, très discret, en haut de section */
		...
		<div class="client-carousel__one alefox-owl__carousel owl-theme owl-carousel" data-owl-options='{
			...
			<?php foreach ( $partners as $partner ) : ?>
				<div class="client-carousel__one__item">
					<img src="<?php echo esc_url( get_template_directory_uri() . '/assets/images/brand/' . $partner['logo'] ); ?>" alt="<?php echo esc_attr( $partner['name'] ); ?>">
				</div>
			<?php endforeach; ?>
		</div>
