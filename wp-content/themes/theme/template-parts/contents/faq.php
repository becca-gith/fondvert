<?php
/**
 * Template part : Foire aux questions (dynamique)
 * Récupère les questions depuis le Custom Post Type "faq"
 *
 * @package TogoGreenFund
 */

// Récupération des FAQs (CPT 'faq')
$faq_query = new WP_Query( array(
    'post_type'      => 'faq',
    'posts_per_page' => -1,                // toutes les FAQs
    'post_status'    => 'publish',
    'orderby'        => 'menu_order',      // ordre manuel via l'attribut "Ordre du menu"
    'order'          => 'ASC',
) );

// Fallback si aucune FAQ n'est trouvée
if ( ! $faq_query->have_posts() ) {
    ...
    while ( $faq_query->have_posts() ) {
        ...
        $faq_items[] = array(
            ...
            'reponse'  => get_the_content(),
        );
    }
    wp_reset_postdata();
}

// On ne garde que les 6 premières FAQ pour l'affichage (ajustez si besoin)
$faq_items = array_slice( $faq_items, 0, 6 );

// Ajout d'un numéro séquentiel pour l'affichage (01, 02, ...)
$display_items = array();
...
<style>
    ...
    .faq-accordion .accordion-main { flex: 1; min-width: 0; }
    ...
    .faq-accordion .accordion-button .label { flex: 1; }
    .faq-accordion .accordion-button.active { color: var(--faq-green-dark); }
    ...
    .fvt-faq__contact-text { position: relative; z-index: 1; }
