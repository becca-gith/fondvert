<?php
/**
 * Template part : Page "Eau et Assainissement" – version statique
 * Togo Green Fund
 *
...
//Chiffres clés
$chiffres_eau = array(
'8 000' => 'Ménages ayant accès à l\'eau potable',
'150'  => 'Points d\'eau réhabilités ou construits',
'25 000'    => 'Personnes sensibilisées à l\'hygiène',
'30%'    => 'Réduction des maladies hydriques',
);
...
<section class="agriculture-content">
	<div class="container">
			...
			<div class="agriculture-intro__card">
				<div class="agriculture-intro__texte">
					<p class="first-paragraph">
						Dédié au financement des actions et projets relatifs à la gestion durable des ressources en eau, 
						à l'accès à l'eau potable, à l'assainissement, à la gestion des déchets 
						et à la résilience des systèmes hydrauliques face aux effets des changements climatiques ;</p>
					<p>
				...
				<div class="agriculture-intro__image">
					<img src="http://localhost/fondvert/wp-content/uploads/2026/07/eau.jpg?w=600&h=400&fit=crop" alt="Agriculture durable au Togo" loading="lazy">
				</div>
			</div>
		</div>
		...
		<div class="agriculture-chiffres">
			<?php foreach ( $chiffres_eau as $valeur => $label ) : ?>
		...
		<div class="agriculture-section">
			<h2 class="agriculture-section__title"><i class="fas fa-bullseye"></i>Pourquoi Eau et Assainissement?</h2>
