<?php
/**
 * Template part : Page "Energie et Infrastructure Durable " – version statique
 * Togo Green Fund
 *
...
// Chiffres clés
// Énergie et Infrastructure Durable
$chiffres_energie = array(
	'6 000' => 'Ménages équipés en énergie solaire',
	'50'    => 'Infrastructures publiques électrifiées',
	'35%'   => 'Réduction des émissions de CO₂',
	'300'   => 'Emplois verts créés',
);
?>
	...
	<div class="container">
		<nav class="breadcrumb-wrapper" aria-label="Fil d'Ariane">
			<ol>
				...
				<li class="separator">›</li>
				<li class="current"> Energie et Infrastructure Durable</li>
			</ol>
		</nav>
		<span class="agriculture-header__badge"><i class="fas fa-seedling"></i> Togo Green Fund</span>
		<h1>Guichet Energie et Infrastructure Durable</h1>
...
<section class="agriculture-content">
	<div class="container">
			...
			<div class="agriculture-intro__card">
				<div class="agriculture-intro__texte">
					<p class="first-paragraph">
						Dédié au financement des actions et projets contribuant à la réduction des émissions 
						de gaz à effet de serre, à la promotion des énergies renouvelables et de l'efficacité énergétique, 
						aux innovations technologiques, à l'accès aux mécanismes de financement du marché du carbone et au développement d'infrastructures durables, résilientes 
						et à faible empreinte carbone, notamment dans les domaines de l'urbanisme, du bâtiment et des transports.</p>
					<p>
				...
				<div class="agriculture-intro__image">
					<img src="http://localhost/fondvert/wp-content/uploads/2026/07/energie.jpg?w=600&h=400&fit=crop" alt="Agriculture durable au Togo" loading="lazy">
				</div>
			</div>
		</div>
		...
		<div class="agriculture-chiffres">
			<?php foreach ( $chiffres_energie as $valeur => $label ) : ?>
		...
		<div class="agriculture-section">
			<h2 class="agriculture-section__title"><i class="fas fa-bullseye"></i> Pourquoi Energie et Infrastructure Durable ?</h2>
