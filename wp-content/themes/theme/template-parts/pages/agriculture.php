<?php
/**
 * Template part : Page "Agriculture durable" – version statique
 * Togo Green Fund
 *
...
// Chiffres clés
$chiffres = array(
	'12 000' => 'Agriculteurs accompagnés',
	'5 000'  => 'Hectares cultivés durablement',
	'30%'    => 'Augmentation moyenne des rendements',
	'200'    => 'Emplois créés',
);
?>
...
<section class="agriculture-content">
	<div class="container">
			...
			<div class="agriculture-intro__card">
				<div class="agriculture-intro__texte">
					<p class="first-paragraph">
					 Dédié au financement des actions et projets contribuant au développement de pratiques agricoles résilientes et durables, à la sécurité alimentaire et à l'adaptation des systèmes de production agricole aux effets des changements climatiques.</p>
					<p>
		...
		<div class="agriculture-section">
			<h2 class="agriculture-section__title"><i class="fas fa-bullseye"></i> Pourquoi l’agriculture durable ?</h2>
