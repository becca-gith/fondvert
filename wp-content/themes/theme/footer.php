<!-- ============================================================
    ...
    <style>
        ...
        /* ---------- COLONNE 1 : IDENTITÉ (remplace le logo) ---------- */
        .footer-widget--about {
            padding-right: 10px;
        }
        ...
        @media (max-width: 767px) {
            .main-footer__top { padding: 56px 0 30px; }
            .footer-widget--about,
            .footer-widget--links,
            .footer-widget--blog {
                margin-bottom: 40px;
    ...
    <footer class="main-footer background-black">
        <div class="main-footer__bg" style="background-image: url(<?php echo esc_url( get_template_directory_uri() . '/assets/images/backgrounds/footer-bg-1-1.jpg' ); ?>);"></div>
        <!-- /.main-footer__bg -->
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-xl-4">
                        <div class="footer-widget footer-widget--about">
                            ...
                            <!-- Identité : badge armoirie + nom institutionnel (remplace le logo) -->
                    ...
                    <div class="col-md-6 col-xl-2">
                        <div class="footer-widget footer-widget--links footer-widget--links-two">
                            ...
                            <ul class="list-unstyled footer-widget__links">
                                ...
                                <li><a href="<?php echo esc_url( home_url( '/' ) ); ?>"><?php _e( 'Accueil', 'alefox' ); ?></a></li>
                            </ul>
                        </div>
                    </div>

                    <!-- COLONNE 4 : Derniers articles (Actualités) -->
                    <div class="col-md-6 col-xl-3">
                        <div class="footer-widget footer-widget--blog">
                            <h3 class="footer-widget__title"><?php _e( 'Dernières actualités', 'alefox' ); ?></h3>
                            <?php
                            ...
                            <?php else : ?>
                                <p class="footer-widget__text"><?php _e( 'Aucun article récent.', 'alefox' ); ?></p>
                            <?php endif; ?>
                        </div>
                    </div>
    ...
    <div class="mobile-nav__wrapper">
        ...
        <div class="mobile-nav__content">
            ...
            <!-- Menu mobile (remplacé par un menu WordPress) -->
            <?php
            wp_nav_menu( array(
                'theme_location' => 'mobile_menu', // à enregistrer dans functions.php
                'container'      => false,
    ...
    <aside class="sidebar-one">
        ...
        <div class="sidebar-one__content">
            ...
            <ul class="sidebar-one__info">
                ...
                <li><span class="fas fa-envelope"></span> <a href="mailto:denv_togo@yahoo.fr">denv_togo@yahoo.fr</a></li>
                <li><span class="fas fa-phone-alt"></span> <a href="tel:+228XXXXXXXX">+228 XX XX XX XX</a></li>
            </ul>
