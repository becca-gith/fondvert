<?php
/**
 * Template part pour la page "Mission" – version harmonisée avec le header ATC
...
<section class="mission-cta">
    <div class="container">
        <h2>Partagez notre mission</h2>
        <div class="cta-divider"></div>
        <p>Rejoignez l'ATC pour défendre ensemble les droits des consommateurs togolais.</p>
...
<style>
/* ============================================================
   PAGE MISSION – CHARTE ATC (BLEU #011875, ROUGE #B92F29, JAUNE #FFCC00)
   ============================================================ */
:root {
    --bleu-atc:   #011875;
    --rouge-atc:  #B92F29;
